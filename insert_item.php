...
if(mysqli_num_rows($result_0) < 1){
    ...
    $sql = "insert into item (item_code, item_category, item_subcategory, item_name, quantity, unit_price) values('".$item_code."', '".$item_category_id."' , '".$item_subcategory_id."' , '".$item_name."' , '".$quantity."' , '".$unit_price."');";
