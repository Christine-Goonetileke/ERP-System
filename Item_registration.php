...
<div>
    ...
    <div class="container">
        ...
        <form id="item_registration_form" action="insert_item.php" method="POST" onsubmit="return validateForm()">
    ...
    if (isset($_GET['status']) && $_GET['status'] === 'fail') {
        echo '<script>alert("Item already exists! Cannot register. Update item if needed.");</script>';
        $_GET['status']='success';
    }
    ?>
    </div>
